...
cat system/system/app/TrichromeLibrary/TrichromeLibrary.apk.* 2>/dev/null >> system/system/app/TrichromeLibrary/TrichromeLibrary.apk
rm -f system/system/app/TrichromeLibrary/TrichromeLibrary.apk.* 2>/dev/null
...
cat system/system/app/Gmail2/Gmail2.apk.* 2>/dev/null >> system/system/app/Gmail2/Gmail2.apk
rm -f system/system/app/Gmail2/Gmail2.apk.* 2>/dev/null
cat system/system/app/Messages/Messages.apk.* 2>/dev/null >> system/system/app/Messages/Messages.apk
rm -f system/system/app/Messages/Messages.apk.* 2>/dev/null
